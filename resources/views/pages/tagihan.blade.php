                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Semua Tagihan</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                {{-- <a href="" class="btn btn-primary mt-4"> Cari Tagihan</a> --}}
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($tagihan as $t)
                                                <tr>
                                                    ...
                                                    <td>{{$t->customer->tarif->kode}}</td>
                                                    <td>Rp{{$t->customer->tarif->abonemen}}</td>
                                                    <td>Rp{{$t->tagihan}}</td>
                                                    
                                                    @if ($t->status == 1)
                                                    <td><span class="badge bg-danger">Belum Lunas</span></td>
                                                    <td>
                                                        <a href="{{ route('tagihan.show', $t->id) }}">
