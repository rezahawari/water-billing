...
@section('style')
    <link href="{{asset('temp/src/plugins/src/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('temp/src/assets/css/light/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('temp/src/assets/css/dark/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
    <!--  BEGIN CONTENT AREA  -->
...
@endsection
@section('script')
    <script src="{{asset('temp/src/plugins/src/apex/apexcharts.min.js')}}"></script>
    <script src="{{asset('temp/src/assets/js/dashboard/dash_1.js')}}"></script>
@endsection
